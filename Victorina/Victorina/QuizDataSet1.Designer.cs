...
namespace Victorina {
    ...
    public partial class QuizDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ResultsDataTable : global::System.Data.TypedTableBase<ResultsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ResultsRow AddResultsRow(string Thing, int Result) {
...
namespace Victorina.QuizDataSet1TableAdapters {
...
SELECT Id, Thing, Result, UserId FROM Results WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        res.Thing, res.Result\r\nFROM            Results AS res INNER JOIN\r\n " +
                "                        Users AS us ON res.UserId = us.Id AND res.UserId = @id";
        ...
        public virtual int Fill(QuizDataSet1.ResultsDataTable dataTable, int id) {
        ...
        public virtual QuizDataSet1.ResultsDataTable GetData(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            QuizDataSet1.ResultsDataTable dataTable = new QuizDataSet1.ResultsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuizDataSet1.ResultsDataTable dataTable) {
